...
async def get_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"JaanX/assets/rai.png")
        ...
        font = ImageFont.truetype("JaanX/assets/font2.ttf", 45)
        ImageFont.truetype("JaanX/assets/font2.ttf", 70)
        arial = ImageFont.truetype("JaanX/assets/font2.ttf", 30)
        ImageFont.truetype("JaanX/assets/font.ttf", 30)
